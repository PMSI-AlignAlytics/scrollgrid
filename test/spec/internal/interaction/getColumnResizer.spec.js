define(['d3', 'scrollgrid_actual', 'scrollgrid_mock'], function (d3, actual, mock) {
    ...
    describe("getColumnResizer", function () {
        ...
        var underTest = actual.prototype.internal.interaction.getColumnResizer,
            interaction;
        ...
        it("should call the resize start function on drag start", function () {
            ...
            expect(interaction.columnResizeStart).toHaveBeenCalledWith(d3.returnValues.select, 'datum value');
        });
        ...
        it("should call the resizing function on drag", function () {
            ...
            expect(d3.select).toHaveBeenCalled();
            expect(interaction.columnResizing).toHaveBeenCalledWith(d3.returnValues.select, 'datum value', 'invert value');
        });
        ...
        it("should call the resize end function on drag end", function () {
            ...
            expect(d3.select).toHaveBeenCalled();
            expect(interaction.columnResizeEnd).toHaveBeenCalledWith(d3.returnValues.select, 'datum value');
        });
