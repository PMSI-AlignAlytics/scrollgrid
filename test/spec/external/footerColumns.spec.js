define(['d3', 'mock', 'external/footerColumns'], function (d3, mock) {
    "use strict";

    describe("footerColumns", function () {

        var underTest = Scrollgrid.prototype.footerColumns;
