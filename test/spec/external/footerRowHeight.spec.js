define(['d3', 'mock', 'external/footerRowHeight'], function (d3, mock) {
    "use strict";


    describe("footerRowHeight", function () {

        var underTest = Scrollgrid.prototype.footerRowHeight;
        ...
        it("should not refresh if true is passed to the 'silent' argument", function () {
            underTest.call(mock, 13, true);
            expect(mock.refresh).not.toHaveBeenCalled();
        });

        it("should return the column resizing value if no parameter is passed", function () {
            expect(underTest.call(mock)).toEqual(mock.vals.footerRowHeight);
        });
