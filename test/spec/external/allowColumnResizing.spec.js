define(['d3', 'mock', 'external/allowColumnResizing'], function (d3, mock) {
    "use strict";

    describe("allowColumnResizing", function () {

        var underTest = Scrollgrid.prototype.allowColumnResizing;
