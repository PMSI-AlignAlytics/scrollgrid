define(['d3', 'mock', 'external/footerRows'], function (d3, mock) {
    "use strict";

    describe("footerRows", function () {

        var underTest = Scrollgrid.prototype.footerRows;
        ...
        it("should return the column resizing value if no parameter is passed", function () {
            expect(underTest.call(mock)).toEqual(mock.vals.virtBottom);
        });

        it("should update the column resizing value to a passed parameter", function () {
            underTest.call(mock, 13);
            expect(mock.internal.sizes.virtual.bottom).toEqual(13);
        });
